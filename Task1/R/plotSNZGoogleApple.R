...
ggplot(aes(x = date)) +
geom_point(aes(y = weekly_change_driving, colour = "Driving"), size = 1.2) +
geom_point(aes(y = weekly_change_transit, colour = "Transit"), size = 1.2) +
geom_point(aes(y = weekly_change_walking, colour = "Walking"), size = 1.2) +
...
ggplot() +
geom_point(data = mobility_data, aes(x=Date, y = percentageChangeatHome, colour="SNZ"), size = 1.2) +
geom_point(data = google_mobility_data, aes(x=date, y = changeFromBaseline, colour = "Google"), size = 1.2) +
facet_wrap(vars(Bundesland_ENG), nrow = 4) +
theme_bw() +
ylab("Average weekly change in percentage") +
xlab("Date") +
...
ggplot() +
geom_point(data = mobility_data, aes(x=Date, y = outOfHomeDuration, color="Senozon"), size = 1.2) +
geom_point(data = google_mobility_data, aes(x=date, y = timeOutsideHome, color = "Google Mobility Report"), size = 1.2) +
